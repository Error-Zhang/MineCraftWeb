import BlockType from "../definitions/BlockType.ts";
import UVHelper from "../utils/UVHelper.ts";
import { Vector4 } from "@babylonjs/core";

const uvHelper = new UVHelper();

const blockTextureMappingTable: Record<
	Exclude<BlockType, BlockType.AirBlock>,
	{
		faceUvs?: Vector4[];
		stageUvs?: Vector4[];
		regionUv?: Vector4;
...
> = {
	...
	[BlockType.RedFlowerBlock]: {
		singleUv: uvHelper.getUV([12, 0]),
	},
	[BlockType.PurpleFlowerBlock]: {
		singleUv: uvHelper.getUV([13, 0]),
	},
	[BlockType.WhiteFlowerBlock]: {
		singleUv: uvHelper.getUV([14, 0]),
	},
	[BlockType.RyeBlock]: {
	...
	[BlockType.DryBushBlock]: {
		singleUv: uvHelper.getUV([7, 3]),
	},
	[BlockType.LargeDryBushBlock]: {
		singleUv: uvHelper.getUV([7, 4]),
	},
	[BlockType.CactusBlock]: {
		faceUvs: uvHelper.topBottomSide([5, 6], [5, 6], [4, 6]),
	},
	[BlockType.SandBlock]: {
